...
def test_download_url_and_recommendation():
    ...
    assert ollama.recommend_model(8) == ("nemotron-3-nano:4b", "about 2.8 GB")
    assert ollama.recommend_model(16)[0] == "nemotron-3-nano:4b"
    assert ollama.recommend_model(32)[0] == "nemotron-3-nano:4b"
    assert ollama.recommend_model(None)[0] == "nemotron-3-nano:4b"
